...
[OSRS_Scene_Switcher.ahk](https://github.com/null-zero/AHK-Scripts/blob/master/RS_Scene_Switcher.ahk) - Automatically switches scenes when the login button or the bank pin interface is visible in osrs
